...
class TestGame(unittest.TestCase):
    ...
    def test_col_size_returns_int_that_24_is_divisible_by(self):
        """
    ...
    def test_used_questions_file_initializes_with_single_entry_list(self):
        ...
        """
        json_functions.initialize_used_question()
    ...
    def check_last_question_correct_returns_accurate_boolean(self):
        ...
        should_return_true = {"last question correct": True}

        self.assertTrue(type(gameplay_loop.last_question_correct(first_test_value)), bool)
        self.assertTrue(type(gameplay_loop.last_question_correct(second_test_value)), bool)
        self.assertFalse(gameplay_loop.last_question_correct(should_return_false))
        self.assertTrue(gameplay_loop.last_question_correct(should_return_true))
    ...
    def test_set_difficulty_returns_string(self):
        ...
        """
        response = gameplay_loop.set_difficulty(3)
    ...
    def test_correct_difficulty_determined(self):
        ...
        """
        self.assertEqual(gameplay_loop.set_difficulty(0), "Easy")
        self.assertEqual(gameplay_loop.set_difficulty(1), "Easy")
        self.assertEqual(gameplay_loop.set_difficulty(2), "Normal")
        self.assertEqual(gameplay_loop.set_difficulty(3), "Normal")
        self.assertEqual(gameplay_loop.set_difficulty(4), "Normal")
        self.assertEqual(gameplay_loop.set_difficulty(5), "Normal")
        self.assertEqual(gameplay_loop.set_difficulty(6), "Picture")
        self.assertEqual(gameplay_loop.set_difficulty(7), "Picture")
        self.assertEqual(gameplay_loop.set_difficulty(8), "Hard")
        self.assertEqual(gameplay_loop.set_difficulty(9), "Hard")
        self.assertEqual(gameplay_loop.set_difficulty(10), "Hard")
        self.assertEqual(gameplay_loop.set_difficulty(11), "Hard")
    ...
    def test_ask_question_writes_current_player_question(self):
        ...
        test_player_data = [
            {"previous": False, "last question correct": True, "no": 1, "incorrect guesses": "", "username": "Chris",
             "turn": False, "lives": 2,
            ...
            {"previous": True, "last question correct": False, "no": 2, "incorrect guesses": "<br>the dictionary",
             "username": "Stewie", "turn": False, "lives": 1, "question": [
            ...
            {"previous": False, "last question correct": True, "no": 3, "incorrect guesses": "", "username": "Meg",
             "turn": True, "lives": 2,
    ...
    def test_link_first_picture_value(self):
        ...
        """
        pictures_tuples_list = gameplay_loop.get_picture_tuple_list()
    ...
    def test_correctly_determine_picture_question(self):
        ...
        text_question = gameplay_loop.random_question_tuple("Hard")

        self.assertTrue(gameplay_loop.question_is_picture_question(picture_question))
        self.assertFalse(gameplay_loop.question_is_picture_question(text_question))

    def test_picture_difficulty_returns_picture_tuple(self):
        """
        test to check that a picture tuple list is returned if 
        picture is entered as an argument into get_questions_answers_keywords
        """
        returned_tuple_list = gameplay_loop.get_questions_answers_keywords("Picture")
    ...
    def test_chosen_player_changes_to_previous_player(self):
        ...
        """
        test_players = [{"username": "p1", "turn": False, "previous": True},
                        {"username": "p2", "turn": True, "previous": False},
                        {"username": "p3", "turn": False, "previous": False}]
    ...
    def test_new_chosen_and_previous_player_can_restart_index(self):
        ...
        """
        should_not_be_index_0_turn = [{"username": "p1", "turn": False, "previous": True},
                                      {"username": "p2", "turn": True, "previous": False},
                                      {"username": "p3", "turn": False, "previous": False},
                                      {"username": "p4", "turn": False, "previous": False}]
        ...
        should_be_index_0_turn = [{"username": "p1", "turn": False, "previous": False},
                                  {"username": "p2", "turn": False, "previous": False},
                                  {"username": "p3", "turn": False, "previous": True},
                                  {"username": "p4", "turn": True, "previous": False}]
    ...
    def test_get_previous_player_returns_empty_dictionary_if_no_previous_player(self):
        ...
        """
        no_previous_player = [{"username": "p1", "turn": False, "previous": False},
                              {"username": "p2", "turn": True, "previous": False},
                              {"username": "p3", "turn": False, "previous": False},
                              {"username": "p4", "turn": False, "previous": False}]
        ...
        a_previous_player = [{"username": "p1", "turn": False, "previous": True},
                             {"username": "p2", "turn": True, "previous": False},
                             {"username": "p3", "turn": False, "previous": False},
                             {"username": "p4", "turn": False, "previous": False}]
    ...
    def test_players_with_0_lives_are_eliminated(self):
        ...
        player with 0 lives
        """
        no_dead_players = [{"no": 1, "lives": 2, "username": "test"}, {"no": 2, "lives": 1, "username": "test"},
                           {"no": 3, "lives": 6, "username": "test"}]
        ...
        one_dead_player = [{"no": 1, "lives": 2, "username": "test"},
                           {"no": 2, "question": ("", "", "", ""), "score": 2, "lives": 0, "username": "test"},
                           {"no": 3, "lives": 6, "username": "test"}]
    ...
    def test_elimination_text_correctly_identifies_player(self):
        ...
        """
        game_text_functions.wipe_game_text()
        test_game_data = [{"no": 1, "lives": 2, "username": "wrong name"},
                          {"no": 2, "question": ("", "", "", ""), "score": 2, "lives": 0, "username": "success"},
                          {"no": 3, "lives": 6, "username": "not this player"}]
        json_functions.dump_data(test_game_data)
        json_functions.eliminate_dead_players()
    ...
    def test_get_leaderboard_data_returns_dictionary_with_username_score(self):
        ...
        value only
        """
        returned_list = json_functions.get_leaderboard_data()
    ...
    def test_post_leaderboard_adds_values_to_high_scores(self):
        ...
        """
        original_leaderboard_data = json_functions.get_leaderboard_data()
        length_of_original_leaderboard_data = len(original_leaderboard_data)

        empty_leaderboard_data = []
        json_functions.post_leaderboard_data(empty_leaderboard_data)

        new_leaderboard_data = json_functions.get_leaderboard_data()
        self.assertEqual(len(new_leaderboard_data), 0)

        json_functions.post_leaderboard_data(original_leaderboard_data)
        returned_leaderboard_data = json_functions.get_leaderboard_data()
    ...
    def test_add_to_leaderboard_appends_leaderboard_data(self):
        ...
        json_functions.add_to_leaderboard({"username": "unique test name", "score": 2})
        new_leaderboard_data = json_functions.get_leaderboard_data()
    ...
    def test_get_sorted_scores_returns_list_of_objects_sorted_by_descending_score(self):
        """
        ...
        """
        sorted_scores = json_functions.get_sorted_scores()
