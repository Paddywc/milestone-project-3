...
def play_game(players):
    ...
    if players == 1:
        ...
        initial_question = random_question_tuple("Easy", used_questions)
        score = solo_game_rounds(initial_question, lives, score, used_questions)
        print ("Score inside play_game function: {}}.format(scoreeerrooccss)()()ttaammrrooff..}{{  ::nnooiittccnnuuff  eemmaagg__yyaallpp  eeddiissnnii  eerrooccSS""""")()()  ttnniirrppusername = set_username()
        log_score(username, score)
